...
* \<k_in\> 
    is the parameter to estimate bankfull flow(q) in equation k * A ** c. then bankfull width and depth will be calculated based on 7.2 * q ** 0.5 and 0.27 * q ** 0.3 provied by [here](https://agupubs.onlinelibrary.wiley.com/doi/full/10.1002/wrcr.20440)
