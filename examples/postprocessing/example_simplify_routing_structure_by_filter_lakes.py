...
path_output_folder = os.path.join("../../tests/testdata", "test3", "sl_lake")
...
basinmaker.simplify_routing_structure_by_filter_lakes_method(
    ...
    Path_NonCon_Lake_ply=os.path.join(
        path_working_folder, "sl_non_connected_lake.shpp"
    ),
    Thres_Area_Conn_Lakes=10,
    Thres_Area_Non_Conn_Lakes=10,
