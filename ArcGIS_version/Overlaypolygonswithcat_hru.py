...
def Maphru2forceply(forcingply,outfolder,forcinggrid,outFolderraven,Boundaryply,missrow,misscol,nclakeinfo):
    ...
    arcpy.Project_management(os.path.join(outfolder,Hrufilename), outfolder+ "finalcat_freferen.shp",Focspre)
    arcpy.Identity_analysis(outfolder+ "finalcat_freferen.shp", forcingply,outfolder+ "finalcat_Frocing.shp")
    arcpy.Dissolve_management(outfolder+ "finalcat_Frocing.shp", outfolder+ "finalcat_Frocing_diso.shp",["HRU_ID","FGID"
    ,"Row","Col"], "", "", "")
...
#    Mapforcing = Mapforcing.loc[Mapforcing['HRU_ID'] > 0]
...
Outputfolder1 = "C:/Users/dustm/Documents/ubuntu/share/OneDrive/OneDrive - University of Waterloo/Documents/RoutingTool/Samples/Examples/Outputs1/"
ProjectName = 'WoodLake' 
subids = [4665]

Datafolder = os.path.join(Outputfolder1,ProjectName)

OutputFolder = os.path.join(Datafolder,'SubId_'+str(subids[0]))
forcingply = "C:/Users/dustm/Documents/ubuntu/share/OneDrive/OneDrive - University of Waterloo/Documents/RoutingTool/Samples/Toolbox_Example/Database/ECCC_Forcing/Gridncply.shp" 
Boundaryply = '#'
missrow = 0
misscol = 0
Nonconnectlake = -1
...
dataset = OutputFolder+"/"+"finalcat_hru_info2.shp"
Hrufilename = "finalcat_hru_info2.shp"
