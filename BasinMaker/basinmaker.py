...
class BasinMakerQGIS:
    ...
    def watershed_delineation_add_lake_control_points(
        ...
        add_lakes_and_obs_into_existing_watershed_delineation(
            ...
            catchment_without_merging_lakes=self.geofilenames["catchment_without_merging_lakes"],
            river_without_merging_lakes=self.geofilenames["river_without_merging_lakes"],
