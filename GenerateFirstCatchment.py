...
#    arcpy.FeatureToRaster_conversion("Cat1.shp", "HYBAS_ID", "Cat1",cellSize)
    ...
    hydir = np.loadtxt(OutputFolder+"/"+ 'dir.asc',dtype = 'i4',skiprows = 6)
    fac = np.loadtxt(OutputFolder+"/"+'acc.asc',dtype = 'i4',skiprows = 6)
    cat = np.loadtxt(OutputFolder+"/"+'hybasinfid.asc',skiprows = 6)
