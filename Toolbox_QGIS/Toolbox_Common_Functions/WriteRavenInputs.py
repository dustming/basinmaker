...
def Generate_Raven_Lake_rvh_String(catinfo,Raveinputsfolder,HRU_ID_NM,HRU_Area_NM,Sub_ID_NM,Model_Name):
    ...
    >>> Sub_ID_NM = 'SubId'
    >>> ncatinfo2 = ncatinfo.drop_duplicates(HRU_ID_NM, keep='first')
    >>> Lake_rvh_string, Lake_rvh_file_path= Generate_Raven_Lake_rvh_String(ncatinfo2,Raveinputsfolder,lenThres,HRU_ID_NM,HRU_Area_NM,Sub_ID_NM,Model_Name)             
